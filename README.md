...
Xilinx 10.1 ISE works perfectly in Windows 10 and Xilinx 14.7 works in Windows 11. (with some minor Tweaks xilinx 14.7 can be installed on windows 11, the installation procedure is available on Youtube.)
